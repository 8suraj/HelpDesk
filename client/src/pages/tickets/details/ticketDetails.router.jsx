...
// import { Comment, Button1, TextField,getToken } from "../../../components";
...
//     Socket.emit("comment", { ticketId: id, comment: textData,isResolver:userData.isResolver });
//     setComments([...comments,{body:textData,isResolver:userData.isResolver}])
//     resetForm({values:''})
//   };
//    const { data, error, isLoading } = useSWR(
//     [process.env.REACT_APP_API_TICKET_DETAILS,{ticketId:id}],
//     getRequest
//   );
...
//           {comments?.map((item)=>
//             <Comment text={item.body} isSender={userData.isResolver===item.isResolver} isResolver={item.isResolver}
